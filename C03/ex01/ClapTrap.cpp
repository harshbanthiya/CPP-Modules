...
/*   Updated: 2022/07/13 10:54:06 by hbanthiy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string n) : Name(n) , HitPoints(10) , EnergyPoints(10), AttackDamage(0){std::cout << Name << " Constructor Called!" << '\n';}
